...
<div class="mb-6 flex items-center justify-between">
    ...
    <a href="{{ route('admin.blogs.create') }}" class="bg-[#3B7BF8] text-white px-4 py-2 rounded-lg hover:bg-blue-600 transition">
        Nouvel article
    </a>
</div>
            ...
            <tr>
                <td class="px-6 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                        @if($blog->image)
                        <img src="{{ asset('storage/' . $blog->image) }}" alt="" class="w-10 h-10 rounded object-cover mr-3">
                        @endif
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    <a href="{{ route('admin.blogs.edit', $blog) }}" class="text-[#3B7BF8] hover:text-blue-600 mr-3">Modifier</a>
